...
const Create = ({ marketplace, nft }) => {
    ...
    async function OnChangeFile(e) {
        console.log("OnChangeFile is being called")
    ...
    async function listNFT(e) {
        ...
        try {
            ...
            console.log("this is an NFT contract", nft)
            // mint nft 
        ...
        <div className="">
            ...
            <div className="flex flex-col place-items-center mt-10" id="nftForm">
                <form className="bg-white shadow-md rounded px-8 pt-4 pb-8 mb-4">
                    ...
                    <button onClick={listNFT} className="font-bold mt-10 w-full bg-black-500 text-black rounded p-2 shadow-lg">
                        List NFT
                    </button>
                </form>
            </div>
